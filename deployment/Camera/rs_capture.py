...
class RSCapture:
    ...
    def __init__(self, serial_number, dim=(640, 480), fps=15, depth=False, exposure=40000):
...
if __name__ == "__main__":
    ...
    # 获取相机序列号
    capture = RSCapture(serial_number="427622273753", depth=True)
    ret, rgbd = capture.read()
    img = rgbd[...,:3]
    img = img[...,::-1]
    depth = rgbd[...,3]
